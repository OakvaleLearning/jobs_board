...
const Hero = () => {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-brand-800">
      ...
      {/* Soft amber aura top-right + emerald depth, and a fade into the page below. */}
      <div
        className="absolute -top-24 -right-24 -z-[9] h-96 w-96 rounded-full bg-amber-400/20 blur-3xl"
        aria-hidden
      />
      <div
